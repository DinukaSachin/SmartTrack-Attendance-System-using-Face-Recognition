...
class Login:
    def __init__(self,root):
        ...
        self.bg=ImageTk.PhotoImage(file=r"C:\Users\MI COMPUTERS\Documents\Python_Test_Projects\Images_GUI\loginBg1.jpg")
        ...
        img1=Image.open(r"C:\Users\MI COMPUTERS\Documents\Python_Test_Projects\Images_GUI\log1.png")
        img1=img1.resize((100,100),Image.LANCZOS)
        self.photoimage1=ImageTk.PhotoImage(img1)
        lb1img1 = Label(image=self.photoimage1,bg="black")
        ...
        #label1 
        username =lb1= Label(frame1,text="Username:",font=("times new roman",15,"bold"),fg="white",bg="black")
        ...
        loginbtn=Button(frame1,command=self.login,text="Login",font=("times new roman",15,"bold"),bd=0,relief=RIDGE,fg="white",bg="green",activeforeground="white",activebackground="#007ACC")
        loginbtn.place(x=33,y=320,width=270,height=35)


        # Creating Button Registration
        loginbtn=Button(frame1,command=self.reg,text="Register",font=("times new roman",10,"bold"),bd=0,relief=RIDGE,fg="white",bg="purple",activeforeground="orange",activebackground="#002B53")
        loginbtn.place(x=33,y=370,width=50,height=20)


        # Creating Button Forget
        loginbtn=Button(frame1,command=self.forget_pwd,text="Forget",font=("times new roman",10,"bold"),bd=0,relief=RIDGE,fg="white",bg="red",activeforeground="orange",activebackground="#002B53")
    ...
    def login(self):
        if (self.txtuser.get()=="" or self.txtpwd.get()==""):
            ...
            messagebox.showinfo("Sussessfully","Welcome to SmartTrack Attendance System")
        else:
            
            try:
                conn = mysql.connector.connect(user='root', password='Lucifer@0330',host='localhost',database='face_recognition',port=3306)
               
                if conn.is_connected():
                    print("Connected to MySQL database")
            except Error as e:
                print(f"Error NIKULK: {e}")
    ...
    def forget_pwd(self):
        if self.txtuser.get()=="":
            ...
            if row==None:
                ...
                self.combo_security["values"]=("Select","Mothers Name","Your Nick Name","Your Favorite Book")
