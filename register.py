...
class Register:
    def __init__(self,root):
        ...
        self.bg_image = Image.open(r"C:\Users\MI COMPUTERS\Documents\Python_Test_Projects\Images_GUI\bgReg.jpg")
        self.bg_image = self.bg_image.resize((1280, 720), Image.ANTIALIAS)  # Resize image to window size
