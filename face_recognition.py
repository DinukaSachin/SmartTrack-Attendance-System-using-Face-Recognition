...
class Face_Recognition:
    ...
    def __init__(self,root):
        ...
        #title section
        title_lb1 = Label(bg_img,text="Welcome to Face Scan",font=("Times New Roman",30,"bold"),bg="white",fg="black")
        title_lb1.place(x=0,y=0,width=1366,height=45)

        # Create buttons below the section 
        # ------------------------------------------------------------------------------------------------------------------- 
        # Training button 1
        std_img_btn=Image.open(r"Images_GUI\f_det1.jpg")
        ...
        std_b1_1 = Button(bg_img,command=self.face_recog,text="Scan",cursor="hand2",font=("Times New Roman",15,"bold"),bg="black",fg="white")
