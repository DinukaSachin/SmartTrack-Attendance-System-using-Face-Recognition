...
class Student:
    ...
    # This part is image labels setting start 
        # first header image  
        img=Image.open(r"C:\Users\MI COMPUTERS\Documents\Python_Test_Projects\Images_GUI\banner.jpg")
        ...
        f_lb1.place(x=0,y=0,width=1366,height=130)
         ...
         # backgorund image 
        bg1=Image.open(r"C:\Users\MI COMPUTERS\Documents\Python_Test_Projects\Images_GUI\bg3.jpg")
        ...
        #title section
        title_lb1 = Label(bg_img,text="Welcome to Student Management",font=("Times New Roman",30,"bold"),bg="black",fg="white")
        ...
        # Current Course 
        current_course_frame = LabelFrame(left_frame,bd=2,bg="white",relief=RIDGE,text="Current Course",font=("Times New Roman",12,"bold"),fg="black")
        ...
        #label Course
        cou_label=Label(current_course_frame,text="Course",font=("Times New Roman",12,"bold"),bg="white",fg="black")
        ...
        #label Semester 
        year_label=Label(current_course_frame,text="Semester",font=("Times New Roman",12,"bold"),bg="white",fg="black")
        ...
        #Student id
        studentId_label = Label(class_Student_frame,text="Std-ID:",font=("Times New Roman",12,"bold"),fg="black",bg="white")
        ...
        #Student name
        student_name_label = Label(class_Student_frame,text="Std-Name:",font=("Times New Roman",12,"bold"),fg="black",bg="white")
        ...
        #Class Didvision
        student_div_label = Label(class_Student_frame,text="Class Division:",font=("Times New Roman",12,"bold"),fg="black",bg="white")
        ...
        #Roll No
        student_roll_label = Label(class_Student_frame,text="Roll-No:",font=("Times New Roman",12,"bold"),fg="black",bg="white")
        ...
        #Gender
        student_gender_label = Label(class_Student_frame,text="Gender:",font=("Times New Roman",12,"bold"),fg="black",bg="white")
        ...
        #Date of Birth
        student_dob_label = Label(class_Student_frame,text="DOB:",font=("Times New Roman",12,"bold"),fg="black",bg="white")
        ...
        #Email
        student_email_label = Label(class_Student_frame,text="Email:",font=("Times New Roman",12,"bold"),fg="black",bg="white")
        ...
        #Phone Number
        student_mob_label = Label(class_Student_frame,text="Mob-No:",font=("Times New Roman",12,"bold"),fg="black",bg="white")
        ...
        #Address
        student_address_label = Label(class_Student_frame,text="Address:",font=("Times New Roman",12,"bold"),fg="black",bg="white")
        ...
        #Teacher Name
        student_tutor_label = Label(class_Student_frame,text="Tutor Name:",font=("Times New Roman",12,"bold"),fg="black",bg="white")
        student_tutor_label.grid(row=4,column=2,padx=5,pady=5,sticky=W)

        student_tutor_entry = ttk.Entry(class_Student_frame,textvariable=self.var_teacher,width=15,font=("Times New Roman",12,"bold"))
        ...
        #save button
        save_btn=Button(btn_frame,command=self.add_data,text="Save",width=7,font=("Times New Roman",12,"bold"),fg="white",bg="green")
        save_btn.grid(row=0,column=0,padx=5,pady=10,sticky=W)

        #update button
        update_btn=Button(btn_frame,command=self.update_data,text="Update",width=7,font=("Times New Roman",12,"bold"),fg="white",bg="black")
        update_btn.grid(row=0,column=1,padx=5,pady=8,sticky=W)

        #delete button
        del_btn=Button(btn_frame,command=self.delete_data,text="Delete",width=7,font=("Times New Roman",12,"bold"),fg="white",bg="red")
        del_btn.grid(row=0,column=2,padx=5,pady=10,sticky=W)

        #reset button
        reset_btn=Button(btn_frame,command=self.reset_data,text="Reset",width=7,font=("Times New Roman",12,"bold"),fg="white",bg="blue")
        reset_btn.grid(row=0,column=3,padx=5,pady=10,sticky=W)

        #take photo button
        take_photo_btn=Button(btn_frame,command=self.generate_dataset,text="Take Pic",width=9,font=("Times New Roman",12,"bold"),fg="white",bg="purple")
        take_photo_btn.grid(row=0,column=4,padx=5,pady=10,sticky=W)

        #update photo button
        update_photo_btn=Button(btn_frame,text="Update Pic",width=9,font=("Times New Roman",12,"bold"),fg="white",bg="brown")
        ...
        #Phone Number
        search_label = Label(search_frame,text="Search:",font=("Times New Roman",12,"bold"),fg="black",bg="white")
        ...
        search_btn=Button(search_frame,command=self.search_data,text="Search",width=9,font=("Times New Roman",12,"bold"),fg="white",bg="black")
        search_btn.grid(row=0,column=3,padx=5,pady=10,sticky=W)

        showAll_btn=Button(search_frame,command=self.fetch_data,text="Show All",width=8,font=("Times New Roman",12,"bold"),fg="white",bg="black")
